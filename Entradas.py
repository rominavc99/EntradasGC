...
def key_callback(window, key, scancode, action, mods):
    ...
    #Press, release, repeat
            ...
            #print("Se detectó un press de la tecla de escape")
        #if action == glfw.RELEASE:
            #print("Se detectó un release de la tecla de escape")
        #if action == glfw.REPEAT:
            #print("Se detectó un repeat de la tecla de escape")
...
def main():
    ...
    #Establecer el callback de evento de teclado
